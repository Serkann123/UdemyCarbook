    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Brands", x => x.BranId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Piricings", x => x.PricingId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarPricingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarId = table.Column<int>(type: "int", nullable: false),
                    PiricingId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarPricings_Piricings_PiricingId",
                        column: x => x.PiricingId,
                        principalTable: "Piricings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarPricings_PiricingId",
                table: "CarPricings",
                column: "PiricingId");
