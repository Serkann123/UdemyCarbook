...
{
    public class CreateFooterAddressHandler:IRequestHandler<CreateFooterAddressCommand>
    {
        private readonly IRepository<FooterAddress> _repository;
        public CreateFooterAddressHandler(IRepository<FooterAddress> repository)
        {
