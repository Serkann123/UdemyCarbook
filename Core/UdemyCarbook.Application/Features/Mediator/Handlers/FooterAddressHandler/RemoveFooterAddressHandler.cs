...
{
    public class RemoveFooterAddressHandler:IRequestHandler<RemoveFooterAddressComamnd>
    {
        private readonly IRepository<FooterAddress> _repository;

        public RemoveFooterAddressHandler(IRepository<FooterAddress> repository)
        {
